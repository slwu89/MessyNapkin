...
If we square root transform the input data we can see that the
...
Note that we take advantage of sparsity in the Hessian by using
...
![](urchin-laplace_files/figure-commonmark/cell-12-output-1.svg)
